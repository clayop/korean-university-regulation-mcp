...
export function getUniversityBaseUrl(uni: UniversityConfig): string {
  return `${uni.protocol}://${uni.domain}/lmxsrv/law/lawFullContent.do`;
}

export function getUniversityIds(): string[] {
  return Object.keys(UNIVERSITIES);
}

export function getUniversityList(): { id: string; name: string }[] {
